...
plugin_paths = { "/usr/local/lib/prosody/modules", "/usr/src/prosody-modules" }
...
modules_enabled = {
	...
	-- HTTP modules
		...
		"http_upload"; --Enable file sharing between users
...
http_upload_file_size_limit = 209715200
http_max_content_size = 314572800
turncredentials_host = "example.com"
turncredentials_secret="skeet"
